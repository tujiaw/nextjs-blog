...
tags: ['Linux', 'Shell']
draft: false
summary: Summary: Expect helps interact with other programs via scripts. It can remove password input in scp. The provided sync.sh script uses expect to handle password prompts during scp file transfer, e.g., "./sync.sh aaa 172.16.77.100:/home" without password input.  
---
