...
tags: ['Qt']
draft: false
summary: Summary: QLayout 出现“Attempting to add QLayout”警告，因一个 QWidget 作为多个 QLayout 的 parent 致。解决方法可将子 layout 加入主 layout 或给子 layout 指定其他 widget 为 parent。如代码示例所示。 
---
