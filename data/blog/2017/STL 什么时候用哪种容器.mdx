...
tags: ['C/C++']
draft: false
summary: When using STL containers: default to vector for simple data access; use deque for frequent beginning/end ops; list for middle element ops; avoid iterators invalidation; use list or associative containers for exception handling; use set/multiset for searching; hash table for faster lookup; use map/multimap for key/value pairs. 
---
