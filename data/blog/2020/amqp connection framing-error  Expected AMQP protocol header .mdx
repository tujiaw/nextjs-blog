...
tags: ['C/C++']
draft: false
summary: 连接 qqpidd 时报“amqp:connection:framing-error: AMQP header mismatch”，原因是 qpidd 支持 AMQP1.0 和 0 - 10，直接启动不支持 AMQP1.0，需加载 amqp.so 动态库或用 qpidd.conf 配置，帖子 http://qpid.2158936.n2.nabble.com 有帮助。 
---
