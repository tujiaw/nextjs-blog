...
tags: ['Linux']
draft: false
summary: 总结：遇到“Unable to find remote helper for 'https'"是路径问题，需将/usr/libexec/git-core纳入 PATH 或改/etc/profile；“/bin/bash^M: bad interpreter”多因从 windows 上传文件导致编码问题，安装 dos2unix 并转换文件编码即可。 
---
